...
function MoveRatchet()
	ratchet.x = 497.26776123047
	ratchet.y = 309.4133605957
	ratchet.z = 100.28125
end
...
function OnTick(ticks)
    ...
    if (not waiting_for_planet_load) and (ticks % 1000) == 0 then
        if game.planet ~= joba then
            -- User isn't on Joba anymore, they should be! 
