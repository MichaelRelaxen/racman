...
split {
	if(vars.splitCount == 0 && current.destinationPlanet == 2  ||
		...
		vars.splitCount == 6 && current.destinationPlanet == 7 ||
		...
		vars.splitCount == 11 && current.destinationPlanet == 3 ||
		vars.splitCount == 12 && current.destinationPlanet == 3 ||
	...
	if (current.gameState == 0 && current.planet == 20 && vars.splitCount == 17) {
    if (current.neffy == 0 && vars.neffyToggle == 0) {
        vars.neffyToggle = 1;
    }
    if(current.neffy == 1 && vars.neffyToggle == 1) {
        vars.neffyToggle = 2;
    }
    if(current.neffy == 0 && vars.neffyToggle == 2) {
		vars.neffyToggle = 0;
        return true;
    }
}
